...
2. Add proper front matter (title, pubDate, tags: ["neosamurai"], isArchived:
   true)
3. Move to `src/content/blog/YYYY/MM/slug/index.md`

### Writing Cleanup Recipe

Clean up the original writing, but keep the author's voice. The goal is editing,
not rewriting.
...
- The author's framing and narrative arc (e.g., "I had two topics and found
...
- Specific terms and phrases from the original (e.g., "sarcastic disharmony" as
  the artist's concept, not a clever aside)
...
### Batch 5 (Posts 57-70) ✅ COMPLETED

- [x] The Travels of Nishikawa-san (Oct 2006)
- [x] Mewii Christmas (Dec 2006)
- [x] Pink Is Beautiful (Dec 2006)
- [x] Neo Samurai Resolutions (Jan 2007)
- [x] Shibuya University (Jan 2007)
- [x] Shinwa: Yachihoko and Nunakaha (Jan 2007)
- [x] Fuurin Kazan (Jan 2007)
- [x] Names in Shinwa (Jan 2007)
- [x] Shinwa: Ookuninushi's Conquests (Jan 2007)
- [x] Samurai Figurines (Jan 2007)
- [x] Shinwa: Sidestories to End Ookuninushi's Arc (Jan 2007)
- [x] Otokei Underground (Feb 2007)
- [x] Speedy Kotowaza (Feb 2007)
- [~] White Sox Blunder (Aug 2007) — 2 sentences, references missing video
...
**Completed:** 64 migrated posts (all batches complete) **Remaining:** 0 posts
to migrate **Skipped:** 40 posts (too thin, dead media, or not real posts)
