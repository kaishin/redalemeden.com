...
# I'm an developer, designer, and tech writer based in Stockholm.
...
**web** technologies,
**app** development on Apple <img src={AppleLogo} alt="Apple logo" className="inline-icon apple"/> platforms,
 and more recently **server-side** Swift <img src={SwiftLogo} alt="Swift logo" className="inline-icon swift" />.
