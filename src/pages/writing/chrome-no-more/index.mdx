...
audience: "This post was written for people interested in the open Web as a platform."
---
...
<Seo 
  ...
  description={props.pageContext.frontmatter.audience}
  image="social-cards/chrome-no-more.jpg"
  largeImage={true}
/>

<Helmet bodyAttributes={{ class: 'chrome-no-more' }} />

<div className="post-metadata">
  <time date={props.pageContext.frontmatter.date}>{moment(props.pageContext.frontmatter.date).fromNow()}</time>
</div>
...
<small>
<span>{props.pageContext.frontmatter.audience}</span>{' '}
